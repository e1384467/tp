...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                ...
                + NEXT_OF_KIN_DESC_BOB, new AddCommand(expectedPerson));
    ...
    public void parse_repeatedNonTagValue_failure() {
        String validExpectedPersonString = NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + TAG_DESC_FRIEND + IC_DESC_BOB + URGENCY_LEVEL_DESC_BOB + NEXT_OF_KIN_DESC_BOB;
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        assertParseFailure(parser, VALID_NAME_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                        + IC_DESC_BOB + URGENCY_LEVEL_DESC_BOB + NEXT_OF_KIN_DESC_BOB,
                expectedMessage);
        ...
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                        + VALID_IC_BOB + URGENCY_LEVEL_DESC_BOB + NEXT_OF_KIN_DESC_BOB,
                expectedMessage);

        // missing urgency level prefix
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                        + IC_DESC_BOB + VALID_URGENCY_LEVEL_BOB + NEXT_OF_KIN_DESC_BOB,
                expectedMessage);

        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                        + IC_DESC_BOB + URGENCY_LEVEL_DESC_BOB + VALID_NEXT_OF_KIN_BOB,
                expectedMessage);
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB
                        + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                        + TAG_DESC_HUSBAND + TAG_DESC_FRIEND
                        + IC_DESC_BOB + INVALID_URGENCY_LEVEL_DESC + NEXT_OF_KIN_DESC_BOB,
        ...
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB
                        + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                        + TAG_DESC_HUSBAND + TAG_DESC_FRIEND
                        + INVALID_IC_DESC + URGENCY_LEVEL_DESC_BOB + NEXT_OF_KIN_DESC_BOB,
        ...
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB
                        + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                        + TAG_DESC_HUSBAND + TAG_DESC_FRIEND
                        + IC_DESC_BOB + URGENCY_LEVEL_DESC_BOB + INVALID_NEXT_OF_KIN_DESC,
        ...
        assertParseFailure(parser, PREAMBLE_NON_EMPTY + NAME_DESC_BOB
                        ...
                        + TAG_DESC_FRIEND + URGENCY_LEVEL_DESC_BOB
                        + IC_DESC_BOB + NEXT_OF_KIN_DESC_BOB,
